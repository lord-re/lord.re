...
{{< img src="microsoft_zoom.th.jpg" link="microsoft_zoom.jpg" alt="Le glamshot de rigueur où l'on voit bien la scission centrale." title="Ça me fait encore un ptit effet ce design." >}}
...
{{< img src="razer_front.th.jpg" link="razer_front.jpg" alt="Un clavier noir avec un design anguleux" title="razer oblige c'est noir et anguleux. Pas de loupiote sur çui-là." >}}
...
{{< img src="razer_zoom.th.jpg" link="razer_zoom.jpg" alt="Le glam-shot." title="Le plastic est légèrement irisé sur cette photo… La font est moche à souhait mais gamer gamer…" >}}
...
{{< img src="siemens_front.th.jpg" link="siemens_front.jpg" alt="Il est basique et moche" title="Rien de bien folichon. Je ne l'ai quasiment pas utilisé." >}}

Il est assez basique en *PS2* avec un joli câble cependant.

{{< img src="siemens_zoom.th.jpg" link="siemens_zoom.jpg" alt="Le glamshot de base" title="Ouaip. C'est basique. Pour ça que je l'aime pas spécialement." >}}

## Bleudo
C'est pas son vrai nom mais ça lui va plutôt bien !

{{< img src="bleudo_front.th.jpg" link="bleudo_front.jpg" alt="Il a des touches bleues avec des symboles de téléphonies." title="Un peu plus exotiques, hein ?!" >}}
...
{{< img src="bleudo_zoom.th.jpg" link="bleudo_zoom.jpg" alt="le glamshot usuel" title="Je le trouve vraiment sexy celui-là." >}}

## Alcatel 4059
C'est son vrai nom et c'est il est encore plus poussé que le Bleudo niveau téléphonie.

{{< img src="alcatelphone_front.th.jpg" link="alcatelphone_front.jpg" alt="Il possède beaucoup plus de touches dont beaucoup avec des voyants" title="Franchement elles sont pas mimi toutes ces touches avec fenêtre ?" >}}
...
{{< img src="alcatelphone_zoom.th.jpg" link="alcatelphone_zoom.jpg" alt="Encore un glamshot" title="Il a un peu pris la poussière mais admirez quand même ces touches de fonctions.">}}
...
{{< img src="alcatel_zoom.th.jpg" link="alcatel_zoom.jpg" alt="le glamshot encore et toujours" title="Oups le coup d'éponge était pas encore parfaitement sec…">}}
...
{{< img src="sesam_front.th.jpg" link="sesam_front.jpg" alt="Un clavier normal mais avec un lecteur de carte à puce et un petit écran LCD." title="Ho mais qu'est-ce donc que cette excroissance ?" >}}
...
{{< img src="sesam_booting.th.jpg" link="sesam_booting.jpg" alt="L'écran indique qu'il démarre" title="Et il y a un petit bip quand on le branche !">}}
{{< img src="sesam_version.th.jpg" link="sesam_version.jpg" alt="L'écran indique ensuite la version de son firmware" title="Sa version de firmware.">}}

{{< img src="sesam_zoom.th.jpg" link="sesam_zoom.jpg" alt="Son ptit glamshot" title="La simplicité." >}}
...
{{< img src="modelm_front.th.jpg" link="modelm_front.jpg" alt="C'est un énorme clavier avec quelques différences notables comme, par exemple, les touches F1 à F24, pleins de touches de fonction à gauche et les flêches sont dans un ordre qui déroute" title="The beast. Le plus lourd de la collec !" >}}
...
{{< img src="modelm_open.th.jpg" link="modelm_open.jpg" alt="Une fois le plastic supérieur retiré on voit la grosse plaque métallique (et la crasse)." title="Voyez cette feraille ? Ça explique le poids. À quatres roues près, ça ferait un bon skate." >}}

Le connecteur d'origine est un *DIN* assez massif que j'ai remplacé par un *Teensy pour avoir de l'USB*.
...
{{< img src="modelm_hack.th.jpg" link="modelm_hack.jpg" alt="J'ai glissé un petit Teensy à l'intérieur qui tente de convertir le DIN en USB." title="Le hack basique pour avoir de l'USB (j'ai été radin sur la longueur du câble)." >}}
...
{{< img src="modelm_zoom.th.jpg" link="modelm_zoom.jpg" alt="Encore un glamshot" title="Sous les touches se trouvent une 'autre touche'.">}}

## Mon favori !

Mon fait maison fait avec des *Cherry MX Brown* et qui se branche en *USB*.

{{< img src="lrd201905_front.th.jpg" link="lrd201905_front.jpg" alt="Un cadre en bois, une plaque d'alu, des touches bariolées, quelques fils qui dépassent." title="Admirez le souci de la finition !">}}

J'ai un méli-mélo de keycaps avec 4 profils différents.
Une touche qui sert à rien.

{{< img src="lrd201905_zoom.th.jpg" link="lrd201905_zoom.jpg" alt="L'ultime glam shot." title="Il mériterait ptet un ptit coup de décrassage :-°">}}
