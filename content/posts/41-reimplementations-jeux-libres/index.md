...
Dans un genre assez proche, il y a le très connu [**OpenTTD**](https://www.openttd.org/en/) pour Transports Tycoon Deluxe. Il a su se créer une sacrée communauté au point d'avoir suffisamment de main d'œuvre pour pouvoir recréer de nouveaux assets permettant de se passer du jeu originel.
